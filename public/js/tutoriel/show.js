...
/* harmony import */ var _plugins_ago__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../plugins/ago */ "./resources/js/plugins/ago.js");
//import * as $ from "jquery";



var tutoriel_id = $("#tutorielShow").attr('data-id');
...
function loadVideos() {
  if ($("#tutorielVideo")) {
    $.get('/api/tutoriel/' + tutoriel_id).done(function (data) {
...
function loadCountDown() {
  if ($("#tutorielCountDown")) {
    Object(_plugins_ago__WEBPACK_IMPORTED_MODULE_2__["ago"])();
  }
}
