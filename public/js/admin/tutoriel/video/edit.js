...
function editBackground() {
  ...
  var id = '#fileBackground'; // set the preview element template
  ...
  var myDropzone5 = new Dropzone(id, {
    ...
    url: "/api/admin/tutoriel/video/" + tutoriel_id + "/editBackground",
...
function editBanner() {
  // set the dropzone container id
  var id = '#fileBanner'; // set the preview element template
  ...
  var myDropzone5 = new Dropzone(id, {
    // Make the whole body a dropzone
    url: "/api/admin/tutoriel/video/" + tutoriel_id + "/editBanner",
    // Set the url for your upload script location
    parallelUploads: 20,
    maxFiles: 1,
    maxFilesize: 3,
...
function demoCheck() {
  var checkbox = document.getElementById('input_demo');
...
function publishedCheck() {
  var checkbox = document.getElementById('input_published');
  var div = document.getElementById('published_at_field');
  checkbox.addEventListener('change', function (e) {
    if (checkbox.checked === true) {
      console.log('checked');
      div.style.display = 'block';
