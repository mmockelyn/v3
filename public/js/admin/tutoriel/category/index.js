...
/***/ "./resources/js/admin/tutoriel/category/index.js":
/*!*******************************************************!*\
  !*** ./resources/js/admin/tutoriel/category/index.js ***!
  \*******************************************************/
/*! no exports provided */
  ...
  category = $("#listeCategory").KTDatatable({
    ...
    columns: [{
      ...
      template: function template(row) {
        return "\n                    <a href=\"/administrator/tutoriel/category/".concat(row.id, "/delete\" class=\"btn btn-icon btn-sm btn-danger\"><i class=\"la la-trash-o\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
function listeSubCategory() {
  subcategory = $("#listeSubCategory").KTDatatable({
    ...
    columns: [{
      ...
      textAlign: 'right',
      template: function template(row) {
        return "\n                    <a href=\"/administrator/tutoriel/subcategory/".concat(row.id, "/delete\" class=\"btn btn-icon btn-sm btn-danger\"><i class=\"la la-trash-o\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\tutoriel\category\index.js */"./resources/js/admin/tutoriel/category/index.js");
