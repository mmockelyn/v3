...
/***/ "./resources/js/admin/route/download.js":
/*!**********************************************!*\
  !*** ./resources/js/admin/route/download.js ***!
  \**********************************************/
/*! no exports provided */
...
function loadTableDownload() {
  tableauDownload = $("#listeDownload").KTDatatable({
    ...
    columns: [{
      ...
      autoHide: false,
      template: function template(row) {
        return "<span class=\"kt-badge kt-badge--primary kt-badge--inline kt-badge--pill\">".concat(row.typedownload, "</span>");
      }
    }, {
      field: 'typerelease',
      ...
      autoHide: false,
      template: function template(row) {
        return "<span class=\"kt-badge kt-badge--primary kt-badge--inline kt-badge--pill\">".concat(row.typerelease, "</span>");
      }
    }, {
      field: 'published',
      title: "Publier",
      ...
      width: 60,
      template: function template(row) {
        return "\n                    <a href=\"/administrator/route/".concat(route_id, "/download/").concat(row.id, "/edit\" class=\"btn btn-sm btn-outline-info btn-icon\" data-toggle=\"kt-tooltip\" title=\"Editer le t\xE9l\xE9chargement\"><i class=\"la la-edit\"></i> </a>\n                    <a href=\"/api/admin/route/").concat(route_id, "/download/").concat(row.id, "/delete\" class=\"btn btn-sm btn-outline-danger btn-icon\" data-toggle=\"kt-tooltip\" title=\"Supprimer le t\xE9l\xE9chargement\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
/***/ 32:
/*!****************************************************!*\
  !*** multi ./resources/js/admin/route/download.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\route\download.js */"./resources/js/admin/route/download.js");
