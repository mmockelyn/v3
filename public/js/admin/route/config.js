...
/***/ "./resources/js/admin/route/config.js":
/*!********************************************!*\
  !*** ./resources/js/admin/route/config.js ***!
  \********************************************/
/*! no exports provided */
  ...
  var tableTypeDownload = $("#listeTypeDownload").KTDatatable({
    ...
    columns: [{
      ...
      template: function template(row) {
        return "\n                    <a href=\"/api/admin/route/config/type/".concat(row.id, "\" class=\"btn btn-sm btn-icon btn-danger\" data-toggle=\"kt-tooltip\" title=\"Supprimer le type\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
function loadTableTypeRelease() {
  var tableTypeRelease = $("#listeTypeRelease").KTDatatable({
    ...
    columns: [{
      ...
      width: 100,
      template: function template(row) {
        return "\n                    <a href=\"/api/admin/route/config/release/".concat(row.id, "\" class=\"btn btn-sm btn-icon btn-danger\" data-toggle=\"kt-tooltip\" title=\"Supprimer le type\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
/***/ 32:
/*!**************************************************!*\
  !*** multi ./resources/js/admin/route/config.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\route\config.js */"./resources/js/admin/route/config.js");
