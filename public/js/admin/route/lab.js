...
function loadTable() {
  var table = $("#listeAnomalie").KTDatatable({
    ...
    columns: [{
      ...
      width: 100,
      template: function template(row) {
        return "\n                    <a href=\"/administrator/route/".concat(route_id, "/lab/").concat(row.id, "/edit\" class=\"btn btn-sm btn-icon btn-primary\" data-toggle=\"kt-tooltip\" title=\"Editer l'anomalie\"><i class=\"la la-edit\"></i> </a>\n                    <a href=\"/api/admin/route/").concat(route_id, "/anomalie/").concat(row.id, "/delete\" class=\"btn btn-sm btn-icon btn-danger\" data-toggle=\"kt-tooltip\" title=\"supprimer l'anomalie\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
/***/ 29:
/*!***********************************************!*\
  !*** multi ./resources/js/admin/route/lab.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\route\lab.js */"./resources/js/admin/route/lab.js");
