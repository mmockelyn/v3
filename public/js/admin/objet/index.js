  ...
  $.fn[pluginName].defaults = {
    ...
    translate: {
      ...
      extensions: {}
        ...
        /***/ "./resources/js/admin/objet/index.js":
        /*!*******************************************!*\
          !*** ./resources/js/admin/objet/index.js ***!
          \*******************************************/
        /*! no exports provided */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var tableauLatestCategories;
            var tableauLatestObjets;

            function loadLatestCategories() {
                var tableLatestCategories = $("#loadLatestCategories").KTDatatable({
                    data: {
                        type: 'remote',
                        source: {
                            read: {
    ...
    columns: [{
      ...
      template: function template(row) {
        return "\n                    <a href=\"/administrator/objet/category/".concat(row.id, "/delete\" class=\"btn btn-sm btn-icon btn-danger\" data-toggle=\"kt-tooltip\" title=\"Supprimer la cat\xE9gorie\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
function loadLatestObjets() {
  var tableLatestObjets = $("#loadLatestObjects").KTDatatable({
    data: {
      type: 'remote',
      source: {
        read: {
...
/***/ 33:
/*!*************************************************!*\
  !*** multi ./resources/js/admin/objet/index.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\objet\index.js */"./resources/js/admin/objet/index.js");
