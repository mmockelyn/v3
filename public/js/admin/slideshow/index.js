...
/***/ "./resources/js/admin/slideshow/index.js":
/*!***********************************************!*\
  !*** ./resources/js/admin/slideshow/index.js ***!
  \***********************************************/
/*! no exports provided */
...
function loadSlideshow() {
  var tableSlide = $("#loadSlideTable").KTDatatable({
    data: {
      type: 'remote',
      source: {
        read: {
    ...
    columns: [{
      ...
      template: function template(row) {
        return "<img src=\"/storage/slideshow/".concat(row.id, ".png\" width=\"300\" class=\"img-fluid\" />");
      }
    }, {
      field: 'actions',
      title: "Action",
      ...
      width: 100,
      template: function template(row) {
        return "\n                    <a href=\"/administrator/slideshow/".concat(row.id, "/delete\" class=\"btn btn-sm btn-icon btn-danger\" data-toggle=\"kt-tooltip\" title=\"Supprimer le slide\"><i class=\"la la-trash\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
/***/ 53:
/*!*****************************************************!*\
  !*** multi ./resources/js/admin/slideshow/index.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\LOGICIEL\laragon\www\v3.trainznation\resources\js\admin\slideshow\index.js */"./resources/js/admin/slideshow/index.js");
