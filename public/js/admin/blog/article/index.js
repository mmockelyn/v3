...
/***/ "./resources/js/admin/blog/article/index.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/blog/article/index.js ***!
  \**************************************************/
/*! no exports provided */
  ...
  var table = $("#listeArticle").KTDatatable({
    ...
    columns: [{
      ...
      template: function template(row) {
        return "<img src=\"".concat(row.img, "\" width=\"80\" class=\"img-fluid\" />");
      }
    }, {
      field: 'title',
      title: 'Title',
      sortable: 'asc',
      template: function template(row) {
        return "".concat(row.title, "<br><strong>Cat\xE9gorie:</strong> ").concat(row.category);
      }
    }, {
      field: 'published',
      title: 'Publication',
      ...
      template: function template(row) {
        ...
        if (row.published === 0) {
          ...
          return "<span class=\"kt-badge ".concat(published[row.published]["class"], " kt-badge--inline kt-badge--pill\">").concat(published[row.published].title, "</span><br><strong>Date de Publication</strong>: ").concat(row.published_at);
        }
      }
    }, {
      field: 'twitter',
      ...
      template: function template(row) {
        if (row.published === 0) {
          return "\n                            <a href=\"/administrator/blog/article/".concat(row.id, "\" class=\"btn btn-icon btn-sm btn-default\"><i class=\"la la-eye\"></i> </a>\n                            <a href=\"/administrator/blog/article/").concat(row.id, "/edit\" class=\"btn btn-icon btn-sm btn-info\"><i class=\"la la-edit\"></i> </a>\n                            <a href=\"/administrator/blog/article/").concat(row.id, "/delete\" class=\"btn btn-icon btn-sm btn-danger\"><i class=\"la la-trash-o\"></i> </a>\n                        ");
        } else {
          return "\n                            <a href=\"/administrator/blog/article/".concat(row.id, "\" class=\"btn btn-icon btn-sm btn-default\"><i class=\"la la-eye\"></i> </a>\n                        ");
        }
      }
...
module.exports = __webpack_require__(/*! E:\site\trainznation\resources\js\admin\blog\article\index.js */"./resources/js/admin/blog/article/index.js");
