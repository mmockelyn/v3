...
/***/ "./resources/js/admin/blog/category/index.js":
/*!***************************************************!*\
  !*** ./resources/js/admin/blog/category/index.js ***!
  \***************************************************/
/*! no exports provided */
  ...
  var table = $("#listeCategories").KTDatatable({
    ...
    columns: [{
      ...
      template: function template(row) {
        return "\n                    <a href=\"/administrator/blog/category/".concat(row.id, "/edit\" class=\"btn btn-icon btn-sm btn-info\"><i class=\"la la-edit\"></i> </a>\n                    <a href=\"/administrator/blog/category/").concat(row.id, "/delete\" class=\"btn btn-icon btn-sm btn-danger\"><i class=\"la la-trash-o\"></i> </a>\n                    ");
      }
    }],
    translate: {
      records: {
...
module.exports = __webpack_require__(/*! E:\site\trainznation\resources\js\admin\blog\category\index.js */"./resources/js/admin/blog/category/index.js");
