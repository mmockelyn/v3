                    ...
                    <div class="kt-portlet__body">
                        <div class="text-center">
                            @foreach($asset->compatibilities as $compatibility)
                                <span class="badge badge-<?= \App\HelpersClass\Asset\AssetHelper::stateClassCompatibility($compatibility->state); ?>" data-toggle="kt-tooltip" title="<?= $compatibility->trainzbuild->trainz_version_name ?>"><?= $compatibility->trainzbuild->build; ?></span>
                            @endforeach
                        </div>
                    </div>
                </div>
