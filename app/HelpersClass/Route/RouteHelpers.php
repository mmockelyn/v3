...
class RouteHelpers
{
    ...
    {
        switch ($build) {
            case 1: return 'badge bg-red-500';
            case 2: return 'badge bg-purple-500';
            case 3: return 'badge bg-indigo-500';
            case 4: return 'badge bg-amber-500';
            case 5: return 'badge bg-teal-500';
            default: return null;
        }
    }
